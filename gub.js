...
//					console.log(metadata.document);
					...
					var metadata = {
						...
						document_unitdate: metsData.document && metsData.document[0] && metsData.document[0].unitdate[0] ? metsData.document[0].unitdate[0] : '',
						...
						letter_image_unitdate: metsData.letter ? metsData.letter[0].data[0].imagedata[0].unitdate[0] : '',
